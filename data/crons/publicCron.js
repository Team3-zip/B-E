...
const dailyPublicData = () => {
    cron.scheduleJob('0 1 0 * * *', async function () {
        ...
        for (let tc in UATC_list) {
            ...
            const options = {
                method: "GET",
                url: `http://apis.data.go.kr/B552555/lhLeaseNoticeInfo1/lhLeaseNoticeInfo1?serviceKey=${PUB_API_SECRET_KEY}&PG_SZ=300&PAGE=1&PAN_ST_DT=${today}&UPP_AIS_TP_CD=${UATC_list[tc]}`,
        ...
        //     const options = {
        //         method: "GET",
        //         url: `http://apis.data.go.kr/B552555/lhLeaseNoticeInfo1/lhLeaseNoticeInfo1?serviceKey=${PUB_API_SECRET_KEY}&PG_SZ=300&PAGE=1&PAN_ST_DT=${today}&UPP_AIS_TP_CD=39`,
        //         //UPP AIS_TP_CD 05분양주택 06임대주택 39신혼희망타운
        //         headers: {},
        //     };
