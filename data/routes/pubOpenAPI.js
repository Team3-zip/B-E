...
//목록 받기
router.get('/public/:theday', async (req, res, next) => {
        const { theday } = req.params
        ...
        for (let tc in UATC_list) {
            ...
            const options = {
                method: "GET",
                url: `http://apis.data.go.kr/B552555/lhLeaseNoticeInfo1/lhLeaseNoticeInfo1?serviceKey=${PUB_API_SECRET_KEY}&PG_SZ=300&PAGE=1&PAN_ST_DT=${theday}&PAN_ED_DT=${theday}&UPP_AIS_TP_CD=${UATC_list[tc]}`,
